...
// INSERTAR
  ...
  insertReservation: function(fechaInicio, fechaFinal, cliente, habitacion, metodo, cantidad){
    ...
    dbConn.query(sql, function (err, precio) {
      if (err) throw err;
        ...
        dbConn.query(sql, [fechaInicio, fechaFinal, cantidad * parsed.Precio, cliente, habitacion, metodo], function (err, result) {
        if (err) throw err;
          console.log("1 record inserted");
      });
    });
